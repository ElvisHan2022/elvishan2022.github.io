    ...
    /* ---------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        { type: "list", items: [
          ...
          "Stanford Universty, Exchange Student in Biomedical Data Science (2026-2028)",
          "Johns Hopkins University, B.A. Public Health Studies and Economics (2026)",
          "Johns Hopkins University, Minor in Applied Mathematics and Statistcs",
        ]},
        { type: "h", text: "Outside Work" },
        { type: "p", text: "Manga and East Asian literature, Japanese music, history, A24 films, club volleyball, hiking." },
      ],
    },
    ...
    /* ---------------------------------------------------- */
    {
      ...
      blocks: [
        ...
        { type: "entry",
          ...
          text: "Estimating whether starting GLP-1 therapy changes the time adults spend in each stage of sleep (Deep, REM, etc.). Poster abstract submitting to the Bay Area Biotech-Pharma Statistics Workshop.",
        ...
        { type: "entry",
          ...
          text: "Measured brain cell density across regions to test whether two disease genes drove cell loss alone or together. Result: null.",
